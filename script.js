...
`;
  ...
  function updateExitProfitPreview(record) {
    ...
    record._tmp = { exitPrice, highDuringTrade: high, lowDuringTrade: low, resultMemo: memo, exitReason, exitReasonOther: (exitReason === "その他" ? exitReasonOther : ""), profit };
  }
  ...
  function clearExitFormOnly() {
    ...
    r._tmp = { exitPrice: null, highDuringTrade: null, lowDuringTrade: null, resultMemo: "", exitReason: "", exitReasonOther: "", profit: null };
