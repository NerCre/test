...
function detectDeviceType() {
  // Best-effort: "PC" or "モバイル"
  try {
    if (navigator.userAgentData && typeof navigator.userAgentData.mobile === "boolean") {
      return navigator.userAgentData.mobile ? "モバイル" : "PC";
    }
  } catch (e) {}
  const ua = navigator.userAgent || "";
  return /Mobi|Android|iPhone|iPad|iPod/i.test(ua) ? "モバイル" : "PC";
}
...
symbol: $("#entry-symbol").value,
      ...
      deviceType: $("#entry-deviceType")?.value || "",
...
$("#entry-minWinRate").value = "30";
    ...
    $("#entry-deviceType") && ($("#entry-deviceType").value = detectDeviceType());
    $("#entry-ipAddress") && ($("#entry-ipAddress").value = "取得不可");
...
$("#entry-price").value = r.entryPrice ?? "";
    ...
    $("#entry-deviceType") && ($("#entry-deviceType").value = r.deviceType || "");
    $("#entry-ipAddress") && ($("#entry-ipAddress").value = r.ipAddress || "");
