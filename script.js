...
function escapeHtml(s) {
  ...
  function bind() {
    ...
    $("#btn-clear-entry")?.addEventListener("click", () => { clearEntryForm(); showToast("エントリーをクリアしました。", "success"); });
...
$("#btn-exit-clear")?.addEventListener("click", () => { clearExitSelectionAndForm(); showToast("結果をクリアしました。", "success"); });
