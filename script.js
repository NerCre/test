(() => {
  ...
  let entryNotionUrlShadow = ""; // preserve notionUrl when UI field is removed
...
symbol: $("#entry-symbol").value,
      ...
      notionUrl: (($("#entry-notionUrl")) ? $("#entry-notionUrl").value : entryNotionUrlShadow) || "",
...
$("#entry-minWinRate").value = "30";
    ...
    if ($("#entry-notionUrl")) $("#entry-notionUrl").value = "";
    entryNotionUrlShadow = "";
...
$("#entry-price").value = r.entryPrice ?? "";
    ...
    if ($("#entry-notionUrl")) $("#entry-notionUrl").value = r.notionUrl || "";
    entryNotionUrlShadow = r.notionUrl || "";
